...
var _a = require('./index'), readJson = _a.readJson, saveJson = _a.saveJson;
var rootPath = path.resolve(__dirname, '..');
var srcPath = path.resolve(rootPath, 'src');
var pagesPath = path.resolve(srcPath, 'pages');
var entriesPath = path.resolve(srcPath, 'entries');
var configPath = path.resolve(rootPath, 'config/default.json');
function initScript() {
    return __awaiter(this, void 0, void 0, function () {
        var configJson;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, readJson(configPath)];
                case 1:
                    configJson = _a.sent();
